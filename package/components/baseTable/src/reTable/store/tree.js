import { walkTreeNode, getRowIdentity } from '../sourceCode/util';
  ...
  data() {
    return {
      states: {
        ...
        lazy: false,
        lazyTreeNodeMap: {},
        //TODO 目前不使用el-table的树级结构，所以将lazyColumnIdentifier， childrenColumnName设为不常用的字段名
        lazyColumnIdentifier: 'hasChildren-drop',
        childrenColumnName: 'children-drop'
      }
    };
  },
